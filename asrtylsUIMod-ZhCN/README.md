...
将作者 [**astryl**](https://steamcommunity.com/profiles/76561198052137536) 的 16 个 UI / 工具模组聚合汉化为简体中文，一个模组搞定全部。
...
为避免「选项 → Mod 设置」列表被十几个条目刷屏，本汉化隐藏了 16 个 UI 模组的设置条目，改为在 Mod 设置中只显示一个「astryl UI 模组合集」入口，点进去即可分开打开任意已安装模组的设置界面（未安装的不会显示）。

## 依赖

- 上述 16 个原模组（可选择性安装，装了哪个就汉化哪个）
